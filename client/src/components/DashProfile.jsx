...
import { updateFailure, updateStart,updateSuccess,deleteUserStart,deleteUserFailure,deleteUserSuccess } from '../redux/user/userSlice'
            ...
            <Modal.Header/>
             <Modal.Body>
                <div className="text-center">
                    ...
                    <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Aww! Do you really want to part ways with us?</h3>
